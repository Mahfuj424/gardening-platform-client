...
const UserDashboardLayout = ({ children }: LayoutProps) => {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      >
        <h2 className="text-2xl font-bold mb-8 text-black dark:text-white border-gray-500 border-b">
          Dashboard
        </h2>
      ...
      {/* Main content area */}
      <main className="flex-1 p-8 dark:bg-darkBg bg-gray-100">{children}</main>
    </div>
  );
};
